/**********MENUS**********/
CREATE TABLE menus (
                menus_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
...
CREATE TABLE productos (
                productos_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
                nombre VARCHAR2 NOT NULL,
...
CREATE TABLE productos_menus (
                productos_menus_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
                menus_id INTEGER NOT NULL,
                productos_id INTEGER NOT NULL,
                FOREIGN KEY (menu_id) REFERENCES menus(menus_id),
...
/**********AREAS**********/
CREATE TABLE areas (
                areas_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
                nombre VARCHAR2 NOT NULL,
                imagen VARCHAR2
);
...
/**********MESAS**********/
CREATE TABLE mesas (
                mesas_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
                capacidad INTEGER,
                estado INTEGER,
                ...
                FOREIGN KEY (menus_id) REFERENCES menus(menus_id)
...
CREATE TABLE cuentas (
                cuentas_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
                totalMoneda1 FLOAT,
                totalMoneda2 FLOAT,
                numeroCuenta VARCHAR2,
                mesas_id INTEGER NOT NULL,
                clientes_id INTEGER NOT NULL
                FOREIGN KEY (mesas_id) REFERENCES mesas(mesas_id),
